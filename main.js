...
async function renderNotebook(notebook, container) {
  try {
...
function renderMarkdownCell(cell, container) {
  try {
...
function renderCodeCell(cell, container) {
...
var JupyterView = class extends import_obsidian.TextFileView {
  constructor(leaf) {
    super(leaf);
    this.data = "";
  }
  ...
  getDisplayText() {
    var _a;
    return ((_a = this.file) == null ? void 0 : _a.basename) || "Jupyter Notebook";
  }
  // 获取图标
  getIcon() {
    return "code";
...
var JupyterNotebookPlugin = class extends import_obsidian.Plugin {
  async onload() {
    this.registerView(
      VIEW_TYPE_JUPYTER,
